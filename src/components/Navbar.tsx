...
//   { label: 'Our Team', href: '#team', target: '_self' },
//   { label: 'Contact', href: '#contact', target: '_self' },
//   { label: 'Internship', href: '/internship', target: '_self' },
//   { label: 'Publications', href: '/publications', target: '_blank' },
//   // 👈 same tab now
// ]
...
//       {/* Mobile Menu */}
//       {open && (
//         <div className="md:hidden bg-parchment/98 backdrop-blur-md border-t border-gold-500/15 dark:bg-navy-800/98 dark:border-gold-500/10 px-6 py-6 space-y-4">
//           {navLinks.map(link => (
//             <a
//               key={link.label}
//               href={link.href}
